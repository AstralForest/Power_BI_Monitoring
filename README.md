...
**Important Note! There is also alternative version of the soultion which uses Azure Functions for API processing (check out Azure-Functions branch). As a default we recommend using this version as it is less complicated, more secure and allows to load 30 days of history during deployment**
